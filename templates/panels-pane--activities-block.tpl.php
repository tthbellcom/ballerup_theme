<div class="<?php print $classes; ?>" <?php print $id; ?>>
  ...
  <?php print $title; ?>
<div id="kalenderpopup" style="background-color:#ffffff;top:20px;left:-60px;display:none;position:absolute;overflow:hidden;border:1px solid #D9D9D9;width:398px;height:209px"><div style="margin:8px"><form target="_top" name="mdrkalform" action="http://www.kultunaut.dk/perl/arrlist/type-ballerup2" method="get" onsubmit="if (this.ArrKunstner.value == ' Søg fritekst') this.ArrKunstner.value='';">
<div id="nautmdr">
