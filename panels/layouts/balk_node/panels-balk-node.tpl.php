<div class="panel-display container-13 panel-node clearfix" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="panel-panel grid-8 alpha panel-region-middle-top-center">
    <div class="inside"><?php print $content['middle_top_center']; ?></div>
  </div>

  <div class="panel-panel grid-5 omega panel-region-middle-top-right">
    <div class="inside"><?php print $content['middle_top_right']; ?></div>
  </div>
